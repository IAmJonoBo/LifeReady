...
- API version: 0.1.0
- Build date: 2026-02-07T23:11:04.575001+02:00[Africa/Johannesburg]
- Generator version: 7.19.0

This autogenerated project defines an API crate `common` which contains:
...
#[async_trait]
impl common::apis::default::Api for ServerImpl {
  // API implementation goes here
}

impl common::apis::ErrorHandler for ServerImpl {}
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = common::server::new(Arc::new(ServerImpl));
