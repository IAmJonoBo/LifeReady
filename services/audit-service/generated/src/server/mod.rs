    ...
    C: Send + Sync + 'static,
{
    ...
    Router::new()
        ...
        .route("/audit/v1/audit/events",
            post(v1_audit_events_post::<I, A, E, C>)
        )
        .route("/audit/v1/audit/export",
...
let result = api_impl.as_ref().readyz_get(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::audit::ReadyzGetResponse::Status200_ServiceAndCriticalDependenciesAreReadyToServeTraffic
                                                    {
                                                        body,
                                                        x_request_id
                                                    }
                                                ...
                                                apis::audit::ReadyzGetResponse::Status503_ServiceIsReachableButCriticalDependenciesAreNotReady
                                                    {
                                                        body,
                                                        x_request_id
                                                    }
...
where
    ...
    let Some(claims) = claims else {
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    v1_audit_events_post_validation(
          body,
    )
  ).await.unwrap();
...
let result = api_impl.as_ref().v1_audit_events_post(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::audit::V1AuditEventsPostResponse::Status201_Appended
                                                    {
                                                        body,
                                                        x_request_id
                                                    }
                                                ...
                                                apis::audit::V1AuditEventsPostResponse::Status403_Forbidden
                                                    {
                                                        body,
                                                        x_request_id
                                                    }
                                                ...
                                                apis::audit::V1AuditEventsPostResponse::Status409_Conflict
                                                    {
                                                        body,
                                                        x_request_id
                                                    }
...
fn v1_audit_export_get_validation(
  ...
  models::V1AuditExportGetQueryParams,
), ValidationErrors>
{
...
where
    ...
    let Some(claims) = claims else {
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    v1_audit_export_get_validation(
        query_params,
    )
  ).await.unwrap();
...
let result = api_impl.as_ref().v1_audit_export_get(
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::audit::V1AuditExportGetResponse::Status200_ExportReady
                                                    {
                                                        body,
                                                        x_request_id
                                                    }
                                                ...
                                                apis::audit::V1AuditExportGetResponse::Status403_Forbidden
                                                    {
                                                        body,
                                                        x_request_id
                                                    }
                                                ...
                                                apis::audit::V1AuditExportGetResponse::Status404_NotFound
                                                    {
                                                        body,
                                                        x_request_id
                                                    }
